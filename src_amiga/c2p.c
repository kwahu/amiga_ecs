		...
		{			
			for(int b = 0; b < 32; ++b)
			{
				for(int a = 0; a < 32; ++a)
				{
					if(a % 2 || a == 0)
					{
						p1 = 0b11000000 * (((a/2)>>0) & 1);
						p2 = 0b11000000 * (((a/2)>>1) & 1);
						p3 = 0b11000000 * (((a/2)>>2) & 1);
						p4 = 0b11000000 * (((a/2)>>3) & 1);
					}
					else
					{
						p1 = 0b10000000 * (((a/2)>>0) & 1);
						p2 = 0b10000000 * (((a/2)>>1) & 1);
						p3 = 0b10000000 * (((a/2)>>2) & 1);
						p4 = 0b10000000 * (((a/2)>>3) & 1);
						p1 += 0b01000000 * (((a/2-1)>>0) & 1);
						p2 += 0b01000000 * (((a/2-1)>>1) & 1);
						p3 += 0b01000000 * (((a/2-1)>>2) & 1);
						p4 += 0b01000000 * (((a/2-1)>>3) & 1);
					}
					if(b % 2 || b == 0)
					{
						p1 += 0b00110000 * (((b/2)>>0) & 1);
						p2 += 0b00110000 * (((b/2)>>1) & 1);
						p3 += 0b00110000 * (((b/2)>>2) & 1);
						p4 += 0b00110000 * (((b/2)>>3) & 1);
					}
					else
					{
						p1 += 0b00100000 * (((b/2)>>0) & 1);
						p2 += 0b00100000 * (((b/2)>>1) & 1);
						p3 += 0b00100000 * (((b/2)>>2) & 1);
						p4 += 0b00100000 * (((b/2)>>3) & 1);
						p1 += 0b00010000 * (((b/2-1)>>0) & 1);
						p2 += 0b00010000 * (((b/2-1)>>1) & 1);
						p3 += 0b00010000 * (((b/2-1)>>2) & 1);
						p4 += 0b00010000 * (((b/2-1)>>3) & 1);
					}
					if(c % 2 || c == 0)
					{
						p1 += 0b00001100 * (((c/2)>>0) & 1);
						p2 += 0b00001100 * (((c/2)>>1) & 1);
						p3 += 0b00001100 * (((c/2)>>2) & 1);
						p4 += 0b00001100 * (((c/2)>>3) & 1);
					}
					else
					{
						p1 += 0b00001000 * (((c/2)>>0) & 1);
						p2 += 0b00001000 * (((c/2)>>1) & 1);
						p3 += 0b00001000 * (((c/2)>>2) & 1);
						p4 += 0b00001000 * (((c/2)>>3) & 1);
						p1 += 0b00000100 * (((c/2-1)>>0) & 1);
						p2 += 0b00000100 * (((c/2-1)>>1) & 1);
						p3 += 0b00000100 * (((c/2-1)>>2) & 1);
						p4 += 0b00000100 * (((c/2-1)>>3) & 1);
					}
					if(d % 2 || d == 0)
					{
						p1 += 0b00000011 * (((d/2)>>0) & 1);
						p2 += 0b00000011 * (((d/2)>>1) & 1);
						p3 += 0b00000011 * (((d/2)>>2) & 1);
						p4 += 0b00000011 * (((d/2)>>3) & 1);
					}
					else
					{
						p1 += 0b00000010 * (((d/2)>>0) & 1);
						p2 += 0b00000010 * (((d/2)>>1) & 1);
						p3 += 0b00000010 * (((d/2)>>2) & 1);
						p4 += 0b00000010 * (((d/2)>>3) & 1);
						p1 += 0b00000001 * (((d/2-1)>>0) & 1);
						p2 += 0b00000001 * (((d/2-1)>>1) & 1);
						p3 += 0b00000001 * (((d/2-1)>>2) & 1);
						p4 += 0b00000001 * (((d/2-1)>>3) & 1);
					}

					dither2x2[a][b][c][d][0] = p1;
					dither2x2[a][b][c][d][1] = p2;
					dither2x2[a][b][c][d][2] = p3;
					dither2x2[a][b][c][d][3] = p4;
				}
			}
		}
	}
